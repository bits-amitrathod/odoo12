...
class WebsiteSales(odoo.addons.website_sale.controllers.main.WebsiteSale):
    ...
    def payment_confirmation(self, **post):
        ...
        template = request.env.ref('website_sales.website_order_placed_mail_template').sudo()
...
class WebsiteSaleOptionsCstm(odoo.addons.website_sale.controllers.main.WebsiteSale):
    ...
    def modal(self, product_id, **kw):
        ...
        return request.env['ir.ui.view'].render_template("website_sales.modal_optional_products_view", {
            'product': product,
            'quantity': quantity,
