odoo.define('inventory_extension.InventoryPurchaseController', function (require) {
"use strict";
...
var InventoryPurchaseController = BasicController.include({
    custom_events: _.extend({}, AbstractController.prototype.custom_events, FieldManagerMixin.custom_events, {
        ...
        on_click:'action_selected_lines',
    }),
    /**
     * @override
     * @param {Object} params
     ...
     */
     ...
     events: {
        "click": "action_selected_lines",
    },
    action_selected_lines: function(e){
       console.log("action_selected_lines onClick called.....")
       console.log(e)
    },
    init: function (parent, model, renderer, params) {
        console.log("basic controller init called...")
    ...
    canBeDiscarded: function (recordID) {
        console.log("inventory canBeDiscarded called.....")
    ...
    _discardChanges: function (recordID, options) {
        console.log("inventory _discardChanges called...");
        console.log("recordID" );
        console.log(recordID);
        console.log("options");
        console.log(options);
    ...
    _onDiscardChanges: function (ev) {
        console.log("inventory _onDiscardChanges called... ")
        var self = this;
        ev.stopPropagation();
...
core.action_registry.add("inventory_purchase", InventoryPurchaseController);
return InventoryPurchaseController;
});
