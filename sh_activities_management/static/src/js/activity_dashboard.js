    ...
    var ActivityDashboardView = AbstractAction.extend({
            ...
            if (context.tag == 'activity_dashboard.dashboard') {
                self._rpc({
                    ...
                    if (messagesData == false) {
                        ...
                        $('#sh_document_model_id').removeClass('o_hidden');
        ...
        action_all_activities: function (event) {
            ...
            this._rpc({
                ...
                args: ["mail.mail_activity_view_form"],
            })
                .then(function (data) {
                    self.do_action({
        ...
        render_activity_tbl: async function (event) {
            var self = this;
        ...
        action_feedback_done: function (e) {
            ...
            this._rpc({
                ...
                args: [activity_id, $('#activity_feedback').val(),false],
            }).then(function (data) {
                self.render_activity_tbl();
                $(".modal").modal('hide');
            });
        ...
        action_planned_paging: function (ev) {
            var self = this;
            ev.stopPropagation();
            var current_page = $(ev.currentTarget).find(".planned_current_page_value").attr("data-bs-value")
        ...
        action_all_paging: function (ev) {
            var self = this;
            ev.stopPropagation();
            var current_page = $(ev.currentTarget).find(".all_current_page_value").attr("data-bs-value")
            var filter_date = $("#crm_days_filter_list").children("option:selected").val();
            var filter_user = $("#sh_crm_db_user_id").children("option:selected").val();
            var filter_supervisor = $("#sh_crm_db_supervisor_id").children("option:selected").val();
            var filter_model = $('#sh_document_model_id').children("option:selected").val();
            ...
            var start_date = $("#start_date").val();
            var end_date = $("#end_date").val();
            console.log("\n\n\n ---------2----get_sh_crm_activity_all_tbl------>", current_page);
            this._rpc({
                model: "activity.dashboard",
                method: "get_sh_crm_activity_all_tbl",
                args: [filter_date, filter_user, start_date, end_date, filter_supervisor, current_page, filter_model, filter_record, filter_type],
        ...
        action_completed_paging: function (ev) {
            var self = this;
            ev.stopPropagation();
            var current_page = $(ev.currentTarget).find(".completed_current_page_value").attr("data-bs-value")
            var filter_date = $("#crm_days_filter_list").children("option:selected").val();
            var filter_user = $("#sh_crm_db_user_id").children("option:selected").val();
            var filter_supervisor = $("#sh_crm_db_supervisor_id").children("option:selected").val();
            var filter_model = $('#sh_document_model_id').children("option:selected").val();
        ...
        action_overdue_paging: function (ev) {
            var self = this;
            ev.stopPropagation();
            var current_page = $(ev.currentTarget).find(".overdue_current_page_value").attr("data-bs-value")
            var filter_date = $("#crm_days_filter_list").children("option:selected").val();
            var filter_user = $("#sh_crm_db_user_id").children("option:selected").val();
            var filter_supervisor = $("#sh_crm_db_supervisor_id").children("option:selected").val();
            var filter_model = $('#sh_document_model_id').children("option:selected").val();
        ...
        action_cancelled_paging: function (ev) {
            var self = this;
            ev.stopPropagation();
            var current_page = $(ev.currentTarget).find(".cancelled_current_page_value").attr("data-bs-value")
            var filter_date = $("#crm_days_filter_list").children("option:selected").val();
            var filter_user = $("#sh_crm_db_user_id").children("option:selected").val();
            var filter_supervisor = $("#sh_crm_db_supervisor_id").children("option:selected").val();
            var filter_model = $('#sh_document_model_id').children("option:selected").val();
