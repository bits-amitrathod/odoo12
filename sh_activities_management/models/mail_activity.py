...
class ActivityDashboard(models.Model):
    ...
    @api.model
    def get_sh_crm_activity_planned_count_tbl(self, filter_date, filter_user, start_date, end_date, filter_supervisor,filter_model,filter_record):
        doman = [
        ]
...
#         doman = []
    ...
    @api.model
    def get_sh_crm_activity_todo_tbl(self, filter_date, filter_user, start_date, end_date, filter_supervisor, current_page,filter_model,filter_record):
        doman = [('active', '=', True),
...
#         doman = []
    ...
    @api.model
    def get_sh_crm_activity_all_tbl(self, filter_date, filter_user, start_date, end_date, filter_supervisor, current_page,filter_model,filter_record):
        doman = []
...
#         doman = []
    ...
    @api.model
    def get_sh_crm_activity_completed_tbl(self, filter_date, filter_user, start_date, end_date, filter_supervisor, current_page,filter_model,filter_record):
...
#         doman = []
    ...
    @api.model
    def get_sh_crm_activity_overdue_tbl(self, filter_date, filter_user, start_date, end_date, filter_supervisor, current_page,filter_model,filter_record):
        doman = [('active', '=', True),
                 ('date_deadline', '<', fields.Date.today())]
...
#         doman = []
    ...
    @api.model
    def get_sh_crm_activity_cancelled_tbl(self,filter_date,filter_user,start_date,end_date,filter_supervisor,current_page,filter_model,filter_record):
