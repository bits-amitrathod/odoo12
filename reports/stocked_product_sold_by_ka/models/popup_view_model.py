...
class ProductsSoldByKaPopUp(models.TransientModel):
    _name = 'popup.product.sold.by.ka'
    _description = 'Short Date Products sold by KA'
    ...
    def open_table(self):
        ...
        form_view_id = self.env.ref('stocked_product_sold_by_ka.report_product_sold_by_ka_form_view').id

        res_model = 'report.product.sold.by.ka'
        ...
        action = {
            ...
            'view_mode': 'tree',
            'name': 'Short Date Products sold by KA',
            'res_model': res_model,
