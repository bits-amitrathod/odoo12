...
class AccountClosedByBdExport_18(models.TransientModel):
    ...
    def download_excel_bd_account_closed(self):
        ...
        s_date = self.string_to_date(str(self.start_date))
        e_date = s_date - datetime.timedelta(days=365 + (6 * 30))
        e_date_from_first = datetime.date(e_date.year, e_date.month, 1)
        s_date = s_date + datetime.timedelta(days=1)
        ...
        if self.business_development and self.delivery_start_date and self.delivery_end_date:
            return {
                ...
                'url': '/web/export/account_closed_by_bd_export_18/' + str(s_date) + '/' + str(e_date_from_first) + '/' +
            ...
            return {
                'type': 'ir.actions.act_url',
                'url': '/web/export/account_closed_by_bd_export_18/' + str(s_date) + '/' + str(e_date_from_first) + '/' + str('none') +
