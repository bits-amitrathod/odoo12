...
class ExportAccountClosedByBd(http.Controller):
    ...
    # @http.route(
    #     '/web/export/account_closed_by_bd_export/<string:start_date>/<string:end_date>/<string:business_development_id>/'
    #     '<string:delivery_start_date>/<string:delivery_end_date>',
    #     type='http',
    #     auth="public")
    # @serialize_exception
    ...
    #         self.from_data(["Sale Order#", "Customer Name", "Business Development", "Delivery Date", "Status", "Total"],
    #                        records),
    #         headers=[('Content-Disposition', content_disposition('revenue_from_accounts_closed_in_12_months_by_bd' + '.xls')),
    #                  ('Content-Type', 'application/vnd.ms-excel')],
    #     )
    #
    #     return res
