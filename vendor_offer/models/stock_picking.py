...
# UPG_ODOO16_NOTE : below code is added because has_move_lines field has been remove in odoo version 16 and it is causing issue in views
...
# UPG_ODOO16_NOTE:  below code is commented because stock.inventory model has been removed in odoo version 16
# and we need to check another way to do this feature ...............
