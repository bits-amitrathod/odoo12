...
def migrate(cr, version):
    ...
    cr.execute("""update ir_ui_view set active = true where id in (4942,3239,2558, 5740);""")
    cr.execute("""update ir_ui_view set active = true where id in (4938,4936,4937,5734);""")
    ...
    cr.execute("""update ir_ui_view set active = true where id in (5217,5726,3021,5997,3236,5763,5748);""")
