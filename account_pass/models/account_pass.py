...
class account_pass(models.Model):
    ...
    in_stock_report_note = fields.Text(string="In Stock Report Turned On Note")
    ...
    req_freq_note = fields.Text(string="Contact Responsiveness/Request Frequency Note")
    ...
    vendors_purchased_note = fields.Text(string="2 Vendors Purchased Note")
    ...
    purchased_note = fields.Text(string="Has Purchased General Surgery, Ortho, Implant Spine or Implant Biologic Note")
