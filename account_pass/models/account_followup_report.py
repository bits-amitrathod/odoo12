...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_lines(self, options, line_id=None):
        ...
        Need to not show any invoices that have not yet reached the due date
        """
        ...
        for l in partner.unreconciled_aml_ids.sorted().filtered(lambda aml: not aml.currency_id.is_zero(aml.amount_residual_currency)):
            ...
            is_credit = True if l.payment_id.payment_type and l.payment_id.partner_type and l.payment_id.payment_type == 'outbound' and l.payment_id.partner_type == 'customer' else False
            is_overdue = today > l.date_maturity if l.date_maturity else True
            if not is_overdue or is_credit:
                continue
