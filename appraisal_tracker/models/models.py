...
class apprisal_tracker_vendor(models.Model):
    ...
    tier1_extra_retail = fields.Monetary(string="Tier 1 Extra Retail")
    tier2_extra_retail = fields.Monetary(string="Tier 2 Extra Retail")
    less_than_40_extra_retail = fields.Monetary(string="< 40% Extra Retail")
