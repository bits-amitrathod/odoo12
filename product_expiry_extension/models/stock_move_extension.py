    ...
    def write(self, vals):
        ...
        for this in  self:
            ...
            show_lots_m2o = self.has_tracking != 'none' and (
                        self.picking_type_id.use_existing_lots or self.state == 'done' or self.origin_returned_move_id.id),  # able to create lots, whatever the value of ` use_create_lots`.
            ...
            if product_tmpl.tracking =='lot' and group_stock_production_lot and (show_lots_m2o[0] or show_lots_text[0]) :
                try:
                    serialNumber = False;
