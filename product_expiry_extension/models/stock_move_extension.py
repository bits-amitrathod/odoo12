...
class StockMoveExtension(models.Model):
    ...
    def action_show_details(self):
        ...
        if self.picking_id[0].sale_id.team_id.name in ["Website", "My In-Stock Report", "Sales", "Prioritization"] and self.picking_type_id.name in ['Pick'] and self.picking_id[0].sale_id.partner_id.picking_warn in ["block"]:
            return {
