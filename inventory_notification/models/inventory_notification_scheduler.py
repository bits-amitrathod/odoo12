...
class InventoryNotificationScheduler(models.TransientModel):
    ...
    def send_email_after_vendor_offer_conformation(self, purchase_order_id):
        ...
        local_context = {'email_from': super_user_email,
                         ...
                         'descrption': 'Hi Team, <br><br/> ' + ' Vendor Offer has been accepted for <b>' + purchase_order.name + '</b> and Appraisal No# is <b>' + purchase_order.appraisal_no + '</b>' + (' with Offer Type <b>' + purchase_order.offer_type if purchase_order.offer_type+"</b>" else "" ) ,
                         'closing_content': "Thanks & Regards,<br/> Admin Team"}
        try:
            ship_label = None;
