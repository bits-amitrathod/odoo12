            ...
            if (customr.start_date == False and customr.end_date == False) \
                ...
                for sale in sales:
                    ...
                    for line in sale_order_lines:
                        ...
                        if line.product_id.actual_quantity and line.product_id.actual_quantity is not None and line.product_id.actual_quantity > 0 and line.product_id.product_tmpl_id.sale_ok and line.product_id.product_tmpl_id.is_published and line.product_id.active and line.product_id.product_tmpl_id.active:
                ...
                closing_content = """
                                    ...
                                    <p style="text-align: left;"><strong>Kendall Mitchell</strong></p>
                                    <p style="text-align: left;">412-745-0340</p>
                                    </td>
                                    ...
                                    <p style="text-align: left;"><strong>Nicole Folino&nbsp;</strong></p>
            ...
            if purchase_order.shipping_number:
                ship_label = self.env['ir.attachment'].search(
                    [('res_model', '=', 'purchase.order'), ('res_name', '=', purchase_order.name),
                     ('mimetype', '=', 'application/pdf'),('datas_fname','like','%FedEx_Label%')],order="id desc")[0]
